...
public class TechnologyAdapter extends RecyclerView.Adapter<TechnologyAdapter.TechnologyViewHolder> {
    ...
    private List<NewsData_technology> mDataset;
    ...
    public static class TechnologyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TechnologyViewHolder(View v) {
            super(v);
    ...
    public TechnologyAdapter(List<NewsData_technology> myDataset, Context context, View.OnClickListener onClick) {
    ...
    @Override
    public TechnologyAdapter.TechnologyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TechnologyViewHolder vh = new TechnologyViewHolder(v);
    ...
    public void onBindViewHolder(TechnologyViewHolder holder, int position) {
        ...
        NewsData_technology newsData_technology=mDataset.get(position);

        holder.news_title.setText(newsData_technology.getTitle());

        String description = newsData_technology.getDescription();
        if(description != null && description.length() >0){
            holder.news_discription.setText(newsData_technology.getDescription());
        }else {
            holder.news_discription.setText("-----( 중 략 )-----");
        }

        Uri uri = Uri.parse(newsData_technology.getUrlToImage());
        Log.v(TAG, "uri : "+ uri);
    ...
    public NewsData_technology getNews(int position){
